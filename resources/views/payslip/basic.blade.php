              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        <label><b>Allow Leaves</b></label>
                        <input type="number" class="form-control" name="allowLeave" placeholder="Allow Leaves" value="">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1"><b>Gross Salary</b></label>
                        <input type="number" name="grossSalary" class="form-control" placeholder="Gross Salary" value="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <select name="departmentId" id="" style="width: -webkit-fill-available; height: 40px;">
                        
                          <option value="">UIIT</option>
                          <option value="">BIMS</option>
                    ...
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        ...
                        <select name="designationId" id="" style="width: -webkit-fill-available; height: 40px;">
