...
<body class="user-profile">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">HA Technologies</a>
          </div>
        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <center><h3 class="title"><b>HA Technologies</b></h3></center>
                <center><h9 class="title">['Address']</h9></center>
                <center><h3 class="title">Salary Slip</h3></center>
              </div>
              <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="bankname" placeholder="Bank Name" value="">
                      </div>
                    </div>
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Cheque Number</label>
                        <input type="number" class="form-control" placeholder="*******" name="chequenumber" value="">
                      </div>
                    </div>
                </div>
                <div class="row">
  ...
  <tbody>
    <tr>
      <th scope="row">DA</th>
      <td>5,000</td>
      <th scope="row">ProvidentFund</th>
      <td>100</td>
    </tr>
    <tr>
      <th scope="row">HRA</th>
      <td>2500</td>
      <th scope="row"d>E.S.I</th>
      <td>100</td>
    </tr>
    <tr>
    ...
    <tr>
      <th scope="row"></th>
      <td></td>
      <th scope="row">Profession Text</th>
      <td>200</td>
    </tr>
    <tr>
      <th scope="row"></th>
    ...
    <!-- <tr>
      ...
      <td>Nine thousand and two hundred</td>
      <td></td>
      <td></td>
    </tr> -->
  </tbody>
      ...
      <footer class="footer" >
        <div class=" container-fluid ">
          ...
          <div class="copyright" id="copyright">
            ...
            </script>, Designed by <a href="https://www.invisionapp.com" target="_blank">Invision</a>. Coded by Arslan<a href="#" target="_blank"></a>.
          </div>
        </div>
      </footer>
    </div>
